...
class salavatcounter_Options
{
    ...
    public function display_page()
    {
        ...
        if (isset($_GET['addnew'])) {
            ...
            if ($_POST) {
                if (trim($_POST['salavat_title']) != '') {
                    extract($_POST);
                    if (!isset($rounded) || empty($rounded)) $rounded = 0;
                    $insert = $wpdb->insert(
                        $salavatcounter,
                        array(
                            'title' => $salavat_title,
            ...
            <form action="" method="post" id="new-salavat-submit-form">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="salavat_title"><?php _e('zekr', 'salavatcounter') ?></label>
                        </th>
                        <td>
                            <input type="text" name="other_options[zekr]" id="salavat_zekr" value="">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <span class="salavatcounter-hide-me"><strong><?php _e('Enable image', 'salavatcounter'); ?></strong><input
                                        type="checkbox" name="image_show" id="image_show" value="1"
                                        checked="checked"><strong><?php _e('rounded?', 'salavatcounter'); ?></strong><input
                                        type="checkbox" name="rounded" id="rounded" value="1"></span>
                            <span class="salavatcounter-hide-me"><strong><?php _e('image(Leave empty for default image)', 'salavatcounter'); ?></strong><input
                                        type="text" name="image_url" id="image_url" value=""> <button
                                        class="button-secondary"
                                        id="salavatcounter-load-wp-uploader"><?php _e('Select', 'salavatcounter'); ?></button> </span>
                ...
                <input type="submit" value="<?php _e('Add', 'salavatcounter'); ?>" id="new-salavat-submit"
                       name="new-salavat-submit" class="button-primary">
            </form>
            <?php
        }
        ...
        if (isset($_GET['action']) && $_GET['action'] == 'edit' && trim($_GET['salavat']) != '') {
            ...
            if (isset($_POST['update-salavat-submit'])) {
                ...
                $update = $wpdb->update(
                    ...
                    array(
                        ...
                        'status' => $salavat_status,
                        'rounded' => $rounded ?? '',
                        'other_options' => json_encode($other_options),
                    ),
                    array('id' => $id),
                    array(
                        '%s',
            ...
            $other_options = json_decode($row->other_options, 1);
                ...
                <form action="" method="post" id="new-salavat-submit-form">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="salavat_status" id="salavat_status">
                                    <option <?php selected($row->status, '1', true); ?>
                                            value="1"><?php _e('Enable', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->status, '0', true); ?>
                                            value="0"><?php _e('Disable', 'salavatcounter'); ?></option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="salavat_title" id="salavat_title"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="other_options[zekr]" id="salavat_zekr"
                                       value="<?php if (isset($other_options['zekr'])) {
                                           echo $other_options['zekr'];
                                       } ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="salavat_niyat" id="salavat_niyat"
                                       value="<?php echo $row->niyat; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="salavat_view_method" id="salavat_view_method">
                                    <option <?php selected($row->view_method, 'widget', true); ?>
                                            value="widget"><?php _e('Widget', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->view_method, 'corner', true); ?>
                                            value="corner"><?php _e('Corner', 'salavatcounter'); ?></option>
                                </select>

                                <select class="salavatcounter-hide-me" name="salavat_position" id="salavat_position">
                                    <option <?php selected($row->position, 'top-right', true); ?>
                                            value="top-right"><?php _e('top-right', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->position, 'top-left', true); ?>
                                            value="top-left"><?php _e('top-left', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->position, 'top-center', true); ?>
                                            value="top-center"><?php _e('top-center', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->position, 'bottom-right', true); ?>
                                            value="bottom-right"><?php _e('bottom-right', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->position, 'bottom-left', true); ?>
                                            value="bottom-left"><?php _e('bottom-left', 'salavatcounter'); ?></option>
                                    <option <?php selected($row->position, 'bottom-center', true); ?>
                                            value="bottom-center"><?php _e('bottom-center', 'salavatcounter'); ?></option>
                                </select>

                                <br>
                                <span class="salavatcounter-hide-me"><strong><?php _e('Enable image', 'salavatcounter'); ?></strong><input
                                            type="checkbox" name="image_show" id="image_show"
                                            value="1" <?php checked($row->image_show, 1, true); ?>><strong><?php _e('rounded', 'salavatcounter'); ?></strong><input
                                            type="checkbox" name="rounded" id="rounded"
                                            value="1" <?php checked($row->rounded, 1, true); ?>></span>
                                <span class="salavatcounter-hide-me"><strong><?php _e('image(Leave empty for default image)', 'salavatcounter'); ?></strong><input
                                            type="text" name="image_url" id="image_url"
                                            value="<?php echo $row->image_url; ?>"> <button class="button-secondary"
                                                                                            id="salavatcounter-load-wp-uploader"><?php _e('Select', 'salavatcounter'); ?></button> </span>
                    ...
                    <input type="submit" value="<?php _e('Update', 'salavatcounter'); ?>" id="update-salavat-submit"
                           name="update-salavat-submit" class="button-primary">
                </form>
