...
class salavatcounter_lists extends WP_List_Table
{
    ...
    function column_view_method($item)
    {
        if ($item['view_method'] == 'corner') {
            ...
            return sprintf(__('use <a href="%s">widgets</a> or shortcode', 'salavatcounter'), get_bloginfo('url') . '/wp-admin/widgets.php');
        }
...
ALI;
            ...
            $title .= '<hr><span class="salavat-span">ذکر : ' . $zekr . '</span>';
